function ACHANNEL = getanalogchannels(itf, index1, index2,scaled)
...
%   scaled      = logical, do you want scaled data (1) or unscaled (0)
%   OUTPUTS:
...
%%%%%%%%%%%%%%%%%%%%%%%Commented by Peter Adamczyk 2007 March 20.  It
%%%%%%%%%%%%%%%%%%%%%%%_does_ handle Signed data just fine. 
...
for i = 1 : nItems,
    ...
    ACHANNEL.(newstring) = ...
        itf.GetAnalogDataEx(i-1,index1,index2,scaled,0,0,char(0));
