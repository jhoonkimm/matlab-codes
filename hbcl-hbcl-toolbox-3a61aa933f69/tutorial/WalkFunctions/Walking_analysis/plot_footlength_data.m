...
xlabel('Time(% per stride)','fontsize',18);
ylabel('Power(W/mg(gL)^{0.5})','fontsize',18);
title('Right hip joint power','fontsize',18);
...
xlabel('Time(% per stride)','fontsize',18);
ylabel('Power(W/mg(gL)^{0.5})','fontsize',18);
title('Left hip joint power','fontsize',18);
...
title('Right knee joint power','fontsize',18);
...
ylabel('Power(W/mg(gL)^{0.5})','fontsize',18);
title('Left knee joint power','fontsize',18);
...
xlabel('Time(% per stride)','fontsize',18);
%ylabel('Power(W/mg(gL)^{0.5})');
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right ankle joint power','fontsize',18);
...
ylabel('Power(W/mg(gL)^{0.5})','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left ankle joint power','fontsize',18);
...
plot([0.1:0.1:100]',[MRhip_aveR(:,1,1) MRhip_aveR(:,1,2) MRhip_aveR(:,1,3) MRhip_aveR(:,1,4) MRhip_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
%xlabel('Time(% per stride)');
ylabel('Moment(Nm/mgL)','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right hip joint moment','fontsize',18);
...
plot([0.1:0.1:100]',[MLhip_aveR(:,1,1) MLhip_aveR(:,1,2) MLhip_aveR(:,1,3) MLhip_aveR(:,1,4) MLhip_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Moment(Nm/mgL)','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left hip joint moment','fontsize',18);
...
plot([0.1:0.1:100]',[MRkne_aveR(:,1,1) MRkne_aveR(:,1,2) MRkne_aveR(:,1,3) MRkne_aveR(:,1,4) MRkne_aveR(:,1,5)],'linewidth',linewidth);
...
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right knee joint moment','fontsize',18);
...
plot([0.1:0.1:100]',[MLkne_aveR(:,1,1) MLkne_aveR(:,1,2) MLkne_aveR(:,1,3) MLkne_aveR(:,1,4) MLkne_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Moment(Nm//mgL)','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left knee joint moment','fontsize',18);
...
plot([0.1:0.1:100]',-[MRank_aveR(:,1,1) MRank_aveR(:,1,2) MRank_aveR(:,1,3) MRank_aveR(:,1,4) MRank_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);

%xlabel('Time(% per stride)');
%ylabel('Moment(Nm/mgL)');
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right ankle joint moment','fontsize',18);
...
plot([0.1:0.1:100]',[MLank_aveR(:,1,1) MLank_aveR(:,1,2) MLank_aveR(:,1,3) MLank_aveR(:,1,4) MLank_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Moment(Nm/mgL)','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left ankle joint moment','fontsize',18);
...
% axis([0 100 -90 100]);
%xlabel('Time(% per stride)');
ylabel('Degree','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right hip joint angle','fontsize',18);
...
plot([0.1:0.1:100]',-[ALhip_aveR(:,1,1) ALhip_aveR(:,1,2) ALhip_aveR(:,1,3) ALhip_aveR(:,1,4) ALhip_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -90 100]);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Degree','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left hip joint angle','fontsize',18);
...
plot([0.1:0.1:100]',[ARkne_aveR(:,1,1) ARkne_aveR(:,1,2) ARkne_aveR(:,1,3) ARkne_aveR(:,1,4) ARkne_aveR(:,1,5)],'linewidth',linewidth);
axis([0 100 -90 100]);

%xlabel('Time(% per stride)');
%ylabel('Degree');
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right knee joint angle','fontsize',18);
...
plot([0.1:0.1:100]',[ALkne_aveR(:,1,1) ALkne_aveR(:,1,2) ALkne_aveR(:,1,3) ALkne_aveR(:,1,4) ALkne_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -90 100]);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Degree','fontsize',18);
%legend('5  in','9  in','11 in','13 in','15 in');
title('Left knee joint angle','fontsize',18);
...
plot([0.1:0.1:100]',-[ARank_aveR(:,1,1) ARank_aveR(:,1,2) ARank_aveR(:,1,3) ARank_aveR(:,1,4) ARank_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -90 100]);

%xlabel('Time(% per stride)');
%ylabel('Degree');
%legend('5  in','9  in','11 in','13 in','15 in');
title('Right ankle joint angle','fontsize',18);
legend('5  in','9  in','11 in','13 in','15 in');
...
plot([0.1:0.1:100]',[ALank_aveR(:,1,1) ALank_aveR(:,1,2) ALank_aveR(:,1,3) ALank_aveR(:,1,4) ALank_aveR(:,1,5)],'linewidth',linewidth);
% axis([0 100 -90 100]);
...
%%
% figure(3);
% plot([0.1:0.1:100]',RFT_InterPower_aveR,'linewidth',linewidth );
% xlabel('Time(% per stride)','fontsize',18);
...
hold on;
plot([0.1:0.1:100]',[LComP_aveR{1} LComP_aveR{2} LComP_aveR{3} LComP_aveR{4} LComP_aveR{5}],'--', 'linewidth',linewidth);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Work rate(W)','fontsize',18);
legend('5  in','9  in','11 in','13 in','15 in');
name='COM work rate';
saveas(5,name,'ai');
...
hold on
plot([0.1:0.1:100]',LGRFzR_ave,'--','linewidth',linewidth);

xlabel('Time(% per stride)','fontsize',18);
ylabel('Vertical ground reaction force(N)','fontsize',18);
legend('5  in','9  in','11 in','13 in','15 in');
name='GRFRz';
saveas(6,name,'ai');
