...
xlabel('Time(% per stride)','fontsize',18);
%ylabel('Power(W/mg(gL)^{0.5})');
%legend('0  lb','5  lb','15   lb','25  lb','35  lb','45 lb');
...
plot([0.1:0.1:100],-[ARhip_aveR(:,1,1)'; ARhip_aveR(:,1,2)' ;ARhip_aveR(:,1,3)'; ARhip_aveR(:,1,4)'  ],'linewidth',linewidth);
% axis([0 100 -90 100]);;
%xlabel('Time(% per stride)')
...
plot([0.1:0.1:100],-[ALhip_aveR(:,1,1)'; ALhip_aveR(:,1,2)'; ALhip_aveR(:,1,3)' ;ALhip_aveR(:,1,4)' ],'linewidth',linewidth);
% axis([0 100 -90 100]);
...
legend('5  lb','15   lb','25  lb','35  lb','45 lb');
...
%%
figure(5);
plot([0.1:0.1:100]',[RComP_aveR{1} RComP_aveR{2} RComP_aveR{3} RComP_aveR{4} ], 'linewidth',linewidth);
hold on;
