...
plot([0.1:0.1:100]',-[MRhip_aveR(:,1) MRhip_aveR(:,2) MRhip_aveR(:,3) MRhip_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
%xlabel('Time(% per stride)');
...
plot([0.1:0.1:100]',-[MLhip_aveR(:,1) MLhip_aveR(:,2) MLhip_aveR(:,3) MLhip_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
...
plot([0.1:0.1:100]',[MRkne_aveR(:,1) MRkne_aveR(:,2) MRkne_aveR(:,3) MRkne_aveR(:,4)],'linewidth',linewidth);
...
plot([0.1:0.1:100]',[MLkne_aveR(:,1) MLkne_aveR(:,2) MLkne_aveR(:,3) MLkne_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
...
plot([0.1:0.1:100]',-[MRank_aveR(:,1) MRank_aveR(:,2) MRank_aveR(:,3) MRank_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
...
plot([0.1:0.1:100]',[MLank_aveR(:,1) MLank_aveR(:,2) MLank_aveR(:,3) MLank_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -0.25 0.1]);
...
plot([0.1:0.1:100]',-[ARhip_aveR(:,1) ARhip_aveR(:,2) ARhip_aveR(:,3) ARhip_aveR(:,4) ],'linewidth',linewidth);
% axis([0 100 -90 100]);
%xlabel('Time(% per stride)');
...
plot([0.1:0.1:100]',[ALank_aveR(:,1) ALank_aveR(:,2) ALank_aveR(:,3) ALank_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -90 100]);
...
plot([0.1:0.1:100]',[ARkne_aveR(:,1) ARkne_aveR(:,2) ARkne_aveR(:,3) ARkne_aveR(:,4)],'linewidth',linewidth);
axis([0 100 -90 100]);
...
plot([0.1:0.1:100]',[ALkne_aveR(:,1) ALkne_aveR(:,2) ALkne_aveR(:,3) ALkne_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -90 100]);
...
plot([0.1:0.1:100]',-[ARank_aveR(:,1) ARank_aveR(:,2) ARank_aveR(:,3) ARank_aveR(:,4)],'linewidth',linewidth);
% axis([0 100 -90 100]);
...
%%
figure(5);
plot([0.1:0.1:100]',RComP_aveR, 'linewidth',linewidth);
hold on;
...
figure(6);
plot([0.1:0.1:100]',RGRFz_ave,'linewidth',linewidth);
xlabel('Time(% per stride)','fontsize',10);
