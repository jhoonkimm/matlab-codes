function [lmvals,indds]=lmaxmat(xx,filt,varargin)
%LMAXMAT 	function [lmval,indd]=lmaxmat(x,filt,dim)
%	Find local maxima in matrix X, where LMVAL is the output
%	cell array with maxima values, INDD is the corresponding indeces 
